...
const EditarUsuario = () => {
  ...
  const { idUsuario } = parseCookies(); // Assumindo que você tenha uma função parseCookies que retorna um objeto com os cookies
  ...
  const onSubmit = async (formData) => {
    const api = getAPIClient();
    try {
      await api.put(`/users/profile/${idUsuario}`, formData);
